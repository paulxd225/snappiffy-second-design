	...
	return (
		<div
			style={{
				...
				background: "#0e3f15",
				boxShadow:
					"0 40px 80px -40px rgba(14,63,21,.4), 0 0 0 1px rgba(14,63,21,.1)",
			}}
		>
			{playing ? (
				<iframe
				...
				<>
					...
					<div
						style={{
							...
							inset: 0,
							background:
								"linear-gradient(180deg, rgba(14,63,21,.2), rgba(14,63,21,.55))",
						}}
					/>
					<div
						style={{
							...
							borderRadius: 24,
							boxShadow:
								"inset 0 0 0 1px rgba(124,216,90,.3), inset 0 0 60px rgba(155,92,255,.15)",
							pointerEvents: "none",
						}}
					/>
					<button
						...
						style={{
							...
							placeItems: "center",
							boxShadow:
								"0 10px 30px -10px rgba(0,0,0,.3), 0 0 0 8px rgba(255,255,255,.1)",
					...
					>
						<Icons.play
							style={{ width: 26, height: 26, color: "#0e3f15", marginLeft: 4 }}
						/>
					</button>
				</>
			)}
		...
		>
			...
			<div ref={ref} className="container reveal" style={{ paddingTop: 80 }}>
				<div
					...
					style={{ gap: 80, flexWrap: "wrap", alignItems: "flex-start" }}
				>
							...
							{[
								...
								<div
									...
									style={{
										...
										borderRight:
											s.k !== "80%+" ? "1px solid rgba(14,63,21,.12)" : "none",
										paddingLeft: s.k !== "10x" ? 24 : 0,
									}}
								>
									<div
										style={{
